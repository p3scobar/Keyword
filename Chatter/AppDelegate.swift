...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        UINavigationBar.appearance().barTintColor = Theme.tintColor
...
//        UIScrollView.appearance().backgroundColor = Theme.darkBackground
        ...
        UITextField.appearance(whenContainedInInstancesOf: [UISearchBar.self]).backgroundColor = Theme.tintColor
